...
const LOGS = [
  ...
  { agent: "performance", msg: "Analyzing p99 latency spike in api-gateway...", status: "complete" },
  ...
  { agent: "performance", msg: "Heap dump analysis: memory leak in auth-srv detected.", status: "complete" },
  { agent: "architecture", msg: "Cross-referencing deploy #2847 with incident start.", status: "complete" },
];
