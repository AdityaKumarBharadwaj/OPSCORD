    ...
    <div style={{ width: "100%", overflowX: "auto", background: "rgba(0,0,0,0.2)", borderRadius: 16 }}>
      ...
      >
        ...
        <g transform="translate(1000, 500)">
          ...
          <text x="40" y="4" fill="var(--muted)" fontSize={10} fontFamily="var(--font-space-mono)">Sync flow</text>
          <line x1="120" y1="0" x2="150" y2="0" stroke="rgba(255,255,255,0.3)" strokeWidth={1} strokeDasharray="3 3" />
          <text x="160" y="4" fill="var(--muted)" fontSize={10} fontFamily="var(--font-space-mono)">Async</text>
        </g>
      </svg>
    </div>
  );
