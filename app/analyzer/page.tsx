...
export default function AnalyzerPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setResult({ success: false, error: (e as Error).message || String(e) });
    } finally {
      setLoading(false);
    }
  }
  ...
  async function handleFix() {
    ...
    try {
      ...
      setFixError((e as Error).message || String(e));
    } finally {
      setFixing(false);
    }
  }
  ...
  async function handleChat(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.success && res.response) {
       ...
       setChatHistory(prev => [...prev, { role: "model", content: `Error: ${(e as Error).message}` }]);
    } finally {
      setChatting(false);
    }
  }
