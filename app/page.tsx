  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
        ...
        <span style={{ fontFamily: "var(--font-space-mono)", fontSize: 11, color: "#10b981", fontWeight: 700 }}>LIVE</span>
        <span style={{ fontFamily: "var(--font-space-mono)", fontSize: 11, color: "var(--muted)" }}>EVENT STREAM — DEMO</span>
        <span style={{ marginLeft: "auto", fontFamily: "var(--font-space-mono)", fontSize: 11, color: "var(--muted)" }}>
      ...
      {events.map((ev, i) => (
        ...
        >
          ...
          <span style={{ fontFamily: "var(--font-space-mono)", fontSize: 11, color: ev.color, minWidth: 55 }}>{ev.src}</span>
          <span
            style={{
              fontSize: 10,
              fontWeight: 700,
    ...
    <>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          >
            <PulsingDot />
            <span style={{ fontFamily: "var(--font-space-mono)", fontSize: 11, color: "#fca5a5" }}>SEED STAGE</span>
          </div>
          ...
          <button
            ...
            style={{ background: "none", border: "none", color: "var(--text)", fontSize: 22, cursor: "pointer", marginLeft: 4 }}
          >
            ☰
          </button>
        </div>
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 800 }}>
          ...
          >
            OpsCord ingests events from CircleCI, GitHub, Kubernetes &amp; Datadog,
            then uses AI causality scoring to tell you exactly what broke — and{" "}
      ...
      <section id="features" style={{ padding: "80px 5vw", maxWidth: 1080, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16 }}>
          ...
          >
            ...
            <h3 style={{ fontWeight: 700, fontSize: 20, marginBottom: 8 }}>Causality Scoring Engine</h3>
          ...
          >
            ...
            >
              <div style={{ fontFamily: "var(--font-space-mono)", fontSize: 11, color: "var(--muted)", marginBottom: 4 }}>
                events / second
              </div>
              <span
                className="gradient-text"
          ...
          >
            <div style={{ flex: 1, minWidth: 260 }}>
              ...
              <h3 style={{ fontWeight: 700, fontSize: 28, marginBottom: 8 }}>🎯 Unified Incident View</h3>
            ...
            >
              ...
              {[
                { dot: "#ef4444", title: "K8s pod crash → deploy #2847", sev: "Critical", sevC: "#ef4444" },
          ...
          >
            ...
            <div style={{ fontSize: 36, marginBottom: 12 }}>🔗</div>
            <h3 style={{ fontWeight: 700, fontSize: 20, marginBottom: 8 }}>Multi-Source Intelligence</h3>
            <p style={{ color: "var(--muted)", fontSize: 14, lineHeight: 1.7, marginBottom: 20 }}>
      ...
      >
        <div style={{ maxWidth: 1080, margin: "0 auto" }}>
          ...
          >
            {[
              { num: "01", icon: "📥", label: "Events In", color: "#3b82f6", body: "CircleCI, GitHub, K8s & Datadog push events via webhooks or polling" },
              { num: "02", icon: "⚙️", label: "Normalize", color: "#6366f1", body: "Event Processor & Normalizer creates a unified event schema" },
              { num: "03", icon: "🧠", label: "AI Score", color: "#7c3aed", body: "Causality Scoring Engine ranks root causes with confidence scores" },
              { num: "04", icon: "📣", label: "Alert Team", color: "#38bdf8", body: "Results delivered to Slack, Dashboard & Webhooks. Sub-second." },
            ].map((step, i) => (
              <div
                key={i}
                style={{
              ...
              >
                <div style={{ fontFamily: "var(--font-space-mono)", fontSize: 10, color: "var(--muted)", marginBottom: 12 }}>
                  STEP {step.num}
                </div>
                <div style={{ fontSize: 30, marginBottom: 12 }}>{step.icon}</div>
                <div style={{ fontWeight: 700, fontSize: 16, color: step.color, marginBottom: 8 }}>{step.label}</div>
        ...
        <div style={{ maxWidth: 1080, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40 }}>
          ...
          <div>
            ...
            <div className="card" style={{ padding: 22, marginBottom: 16 }}>
              <div style={{ fontFamily: "var(--font-space-mono)", fontSize: 11, color: "var(--muted)", marginBottom: 16, letterSpacing: "0.06em" }}>
              ...
              {[
                ...
                <div key={bar.label} style={{ marginBottom: 14 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: 13, marginBottom: 6 }}>
                    <span>{bar.label}</span>
                    <span style={{ fontFamily: "var(--font-space-mono)", color: bar.color }}>{bar.pct}%</span>
                  </div>
            ...
            >
              <div style={{ fontFamily: "var(--font-space-mono)", fontSize: 11, color: "var(--muted)", marginBottom: 8, letterSpacing: "0.06em" }}>
                ROOT CAUSE IDENTIFIED
              </div>
              <div style={{ fontWeight: 700, fontSize: 16, color: "#a78bfa" }}>🔍 K8s pod OOMKilled</div>
              <div style={{ fontSize: 12, color: "var(--muted)", marginTop: 4 }}>Confidence: 87% · 3 contributing factors</div>
            </div>
          </div>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
              ...
              <tbody>
                {[
                  ...
                  >
                    <td style={{ padding: "12px 16px", fontWeight: row.highlight ? 700 : 400 }}>{row.tool}</td>
                    ...
                    <td style={{ padding: "12px 16px", fontFamily: "var(--font-space-mono)", fontSize: 13 }}>
                      {row.highlight ? (
      ...
      >
        <span className="gradient-text" style={{ fontFamily: "var(--font-space-mono)", fontSize: 18, fontWeight: 700 }}>
          OpsCord
        </span>
        <span style={{ fontSize: 13, color: "var(--muted)" }}>© 2026 OpsCord · Built for DevOps teams · Seed Stage</span>
